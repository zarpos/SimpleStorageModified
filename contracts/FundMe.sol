...
contract FundMe {
    ...
    function fund() public payable {
        ...
        require(
            msg.value.getConversionRate(priceFeed) >= minimunUSD,
            "Didn't send enough!!!"
        ); // With these we are making to set the minimun amount to be funded, equal or greater than the variable "minimunUSD"
    ...
    function withdraw() public onlyOwner {
        // With the onlyOwner part we are adding the modifier that is like a require.
